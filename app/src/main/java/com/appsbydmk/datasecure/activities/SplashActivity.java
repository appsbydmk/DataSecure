...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void proceedAfterPermissions() {
        ...
        if (firstLaunch.getBoolean("first_launch", true)) {
            ...
            homeIntent = new Intent(SplashActivity.this, UserDetailsActivity.class);
            this.startActivityForResult(homeIntent, HelperConstants.USER_DETAILS_STATUS_CODE);
        } else {
    ...
    protected void checkForPermissions() {
        if (ActivityCompat.checkSelfPermission(SplashActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(SplashActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ...
                builder.setMessage("DataSecure needs storage permission.");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == HelperConstants.USER_DETAILS_STATUS_CODE) {
            Toast.makeText(getBaseContext(), "User Details Saved!", Toast.LENGTH_SHORT).show();
            homeIntent = new Intent(SplashActivity.this, MainActivity.class);
            this.startActivity(homeIntent);
            this.finish();
        }
